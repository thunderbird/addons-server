...
theme_detail_patterns = [
    ...
    url(r'^rmlocale$', views.remove_locale, name='devhub.themes.remove-locale'),
]
...
detail_patterns = [
 ...
 #       name='devhub.submit.version.wizard'),
    ...
    url(r'^validation-result/(?P<result_id>\d+)$',
        views.bulk_compat_result,
        name='devhub.bulk_compat_result'),
    url(r'^validation-result/(?P<result_id>\d+)\.json$',
    ...
    url(r'^rmlocale$', views.remove_locale, name='devhub.addons.remove-locale'),
]
...
ajax_patterns = [
    ...
    url(r'^image/status$', views.image_status, name='devhub.ajax.image.status'),
]
redirect_patterns = [
    url(r'^addon/edit/(\d+)',
...
urlpatterns = decorate(use_primary_db, [
    ...
    url(r'^addon/check-compatibility$', views.check_addon_compatibility,
